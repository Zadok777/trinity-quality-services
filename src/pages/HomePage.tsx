          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                We use professional-grade equipment and eco-friendly cleaning solutions to ensure the best results while being mindful of the environment and your property.
              </p>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-xl font-semibold text-trinity-navy mb-3">Eco-Friendly Solutions</h3>
              <p className="text-gray-600">
                We use environmentally friendly cleaning solutions that are safe for your family, pets, and plants.
              </p>
            </div>
